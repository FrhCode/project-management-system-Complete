          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ \Helper::formatSizeUnits(498005) }}</td>
                <td>BSDP 1</td>
                ...
                <td>UAT.pdf</td>
                <td>{{ \Helper::formatSizeUnits(284899983) }}</td>
                <td>BSDP 1 Pinca</td>
                <td class="text-right py-0 align-middle">
                  <div class="btn-group btn-group-sm">
                    <a href="#" class="btn btn-info"><i class="fas fa-eye"></i></a>
                ...
                <td>{{ \Helper::formatSizeUnits(579003) }}</td>
                <td>BSDP 1</td>
                <td class="text-right py-0 align-middle">
                  <div class="btn-group btn-group-sm">
                    <a href="#" class="btn btn-info"><i class="fas fa-eye"></i></a>
                ...
                <td>Logo.png</td>
                <td>{{ \Helper::formatSizeUnits(50517790) }}</td>
                <td>BSDP 1</td>
                <td class="text-right py-0 align-middle">
                  <div class="btn-group btn-group-sm">
                    <a href="#" class="btn btn-info"><i class="fas fa-eye"></i></a>
                ...
                <td>{{ \Helper::formatSizeUnits(4479715) }}</td>
                <td>BSDP 1</td>
                <td class="text-right py-0 align-middle">
                  <div class="btn-group btn-group-sm">
                    <a href="#" class="btn btn-info"><i class="fas fa-eye"></i></a>
